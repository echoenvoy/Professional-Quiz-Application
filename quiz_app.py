...
class QuizApp:
    ...
    def show_results(self):
        """Display the quiz results - FIXED LAYOUT"""
        self.clear_window()
        ...
        top_frame = tk.Frame(main_container, bg=COLORS['background'], height=120)
        top_frame.pack(fill='x', pady=(10, 0))
        top_frame.pack_propagate(False)  # Fixed height
        ...
        # Bottom section for buttons (20% of height)
        bottom_frame = tk.Frame(main_container, bg=COLORS['background'], height=100)
        bottom_frame.pack(fill='x', side='bottom', pady=(10, 20))
        ...
        restart_btn = ttk.Button(button_frame,
                                ...
                                style='Primary.TButton',
                                command=self.start_quiz)
        restart_btn.pack(side='left', padx=10, ipadx=20, ipady=10)
        ...
        menu_btn.pack(side='left', padx=10, ipadx=20, ipady=10)
        ...
        quit_btn = ttk.Button(button_frame,
                             ...
                             style='Primary.TButton',
                             command=self.root.quit)
        quit_btn.pack(side='left', padx=10, ipadx=20, ipady=10)
        
        # Configure weights for resizing
        main_container.grid_rowconfigure(0, weight=0)  # Top frame - fixed
        main_container.grid_rowconfigure(1, weight=1)  # Middle frame - expands
        main_container.grid_rowconfigure(2, weight=0)  # Bottom frame - fixed
